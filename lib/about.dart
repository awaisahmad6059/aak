              ...
              child: Column(
                children: [
                  ...
                  SizedBox(
                    ...
                    child: TextButton(
                      onPressed: () {
                        _launchUrl('https://drive.google.com/file/d/1ro5fG40oFtKLHda9LPJiBacnb1m0xo-Z/view?usp=sharing');
                      },
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      IconButton(
                        onPressed: () {
                          _launchUrl('https://www.linkedin.com/in/awaisahmad6059');
                        },
                        icon: Icon(FontAwesomeIcons.linkedin, color: Colors.white),
                      ),
                      IconButton(
                        onPressed: () {
                          _launchUrl('https://github.com/awaisahmad6059/');
                        },
